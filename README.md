...
1. [API](#API)
1. [Декомпозиция задачи](#Декомпозиция-задачи)
...
* Тело ответа (код 201):
  ...
  * Массив вариантов голосования, для каждого из которых:
    * id - id созданного варианта голосования,
    * name - название варианта,
    * vote_count - количество голосов, при создании равно 0,
    * poll - id голосования, к которому относится данный вариант.
...
4. Тестирование
   ...
   * нагрузочное тестирование.
5. Контейнеризация
   * генерирование файла requirements.txt со всеми требуемыми библиотеками и их версиями,
   * настройка Docker: Dockerfile и docker-compose.yml.
